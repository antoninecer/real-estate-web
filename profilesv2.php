...
$stmt->bindValue(':category_type_cb',$_POST['category_type_cb']);
...
<input type="radio" name="category_type_cb" value="1" <?=$profile['category_type_cb']==1?'checked':''?>>
Prodej
</label>
<label style="margin-right:12px">
<input type="radio" name="category_type_cb" value="2" <?=$profile['category_type_cb']==2?'checked':''?>>
Pronájem
</label>
</td>
</tr>
...
<a href="profilesv2.php?run_scan=1" style="margin-left:20px">
